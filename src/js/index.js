...
const repairBlockReadMoreText =
  repairBlockReadMoreBtn && repairBlockReadMoreBtn.querySelector('.read-more-button__text');
const repairBlockReadMoreImg =
  repairBlockReadMoreBtn && repairBlockReadMoreBtn.querySelector('.read-more-button__image');
...
const technicsToggleText =
  technicsToggleBtn && technicsToggleBtn.querySelector('.read-more-button__text');
const technicsToggleImg =
  technicsToggleBtn && technicsToggleBtn.querySelector('.read-more-button__image');
...
// Кнопка "Показать все" для типов техники
